...
"""
The module file for dme_nxos_interfaces
"""
...
- name: Gather interfaces facts from the device using dme_nxos_interfaces
  cisco.dme_nxos.dme_nxos_interfaces:
    state: gathered
...
from ansible_collections.cisco.dme_nxos.plugins.module_utils.network.dme_nxos.config.interfaces.interfaces import (
    Interfaces,
)
