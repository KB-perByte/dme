...
from ansible_collections.cisco.dme_nxos.plugins.module_utils.network.dme_nxos.argspec.ntp_global.ntp_global import (
    Ntp_globalArgs,
)
from ansible_collections.cisco.dme_nxos.plugins.module_utils.network.dme_nxos.config.ntp_global.ntp_global import (
    Ntp_global,
)
